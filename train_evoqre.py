...
from algorithm.EvoQRE import EvoQRE # New import
...
if __name__ == "__main__":
    ...
    # Default to EvoQRE config
    parser.add_argument("--RL_config", default="EvoQRE", type=str) 
    parser.add_argument(
        "--track",
    ...
    parser.add_argument("--workspace", type=str, default='EvoQRE') # Default to EvoQRE
    ...
    # Initialize EvoQRE Agents
    if args.workspace == 'EvoQRE':
        agents = [EvoQRE(
        ...
        # Default fallback or TrafficGamer
        agents = [TrafficGamer(
                state_dim=model.num_modes * config["hidden_dim"],
                agent_number=agent_num,
                config=config,
    ...
    if args.save:
        ...
        for i, agent in enumerate(agents):
            ...
            # value_state_dict = agent.value.state_dict() # EvoQRE doesn't use standard ValueNet
